...
namespace NET1_Snigur.Example
{
    public class TestCode {
        ...
        private static List<DataLink> lnk = new List<DataLink>() {
            new DataLink(1, 1),
            new DataLink(1, 2),
            new DataLink(1, 4),
            new DataLink(2, 1),
        ...
        private static List<Data> GetPage(List<Data> data, int pageNum, int pageSize) {
